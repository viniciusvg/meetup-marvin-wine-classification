...
def _get_version():
    ...
    with open(join(dirname(__file__), 'marvin_wine_classifier_engine/VERSION'), 'rb') as f:
...
setup(
    name='marvin_wine_classifier_engine',
    version=_get_version(),
    url='',
    description='Marvin engine',
    long_description=open(join(dirname(__file__), 'README.md')).read(),
    author='Vinicius Galhardi',
    maintainer='Vinicius Galhardi',
    maintainer_email='vinicius.galhardi@b2wdigital.com',
